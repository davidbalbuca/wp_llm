...
func TestResolverLinkCortoDeMaps_SoloHostsDeMaps(t *testing.T) {
	...
	if _, _, ok := ResolverLinkCortoDeMaps(srv.URL, cuencaLat, cuencaLng, nil); ok {
...
func TestResolverLinkCortoDeMaps_SinCoordenadas(t *testing.T) {
	...
	if _, _, ok := ResolverLinkCortoDeMaps("https://maps.app.goo.gl/noexiste-"+t.Name(), cuencaLat, cuencaLng, nil); ok {
